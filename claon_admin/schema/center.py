...
class PostRepository:
    ...
    async def find_posts_summary_by_center(session: AsyncSession, center_id: str):
        counts = []
        end_date = datetime.now(TIME_ZONE_KST)
        criteria = ["today", "week", "month", "all", "weeks", "years"]
