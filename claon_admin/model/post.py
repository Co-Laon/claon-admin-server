...
from claon_admin.common.util.time import get_relative_time, now, get_weekday
...
class PostSummaryResponseDto(BaseModel):
    ...
    @classmethod
    def __count_history(cls, standard_date: datetime, history_list: List[PostCountHistory]):
    ...
    @classmethod
    def __get_data_per_period(cls, end_date: datetime, history_list: List[PostCountHistory]):
        ...
        data_per_week = data_per_week.resample("W")["count"].sum().to_frame().T.to_dict("records")[0]
