...
class TestUpdate(object):
    ...
    async def test_update(
        ...
        # when
        result = await center_service.update(center_id=center_fixture.id, subject=request_user, dto=center_update_request_dto)
        # then
    ...
    async def test_update_with_none_user_id(
        ...
        with pytest.raises(BadRequestException) as exception:
            # when
            await center_service.update(center_id=center_fixture.id, subject=request_user, dto=center_update_request_dto)
